...
class Raycaster:
	...
	def __init__( self, sceneName, imW, imH, texPatchW, texPatchH , generate_sequence=False ):
		...
		if generate_sequence:
			self.outPath = os.path.join("/raid/compass/backup/output_long/data/simulated_sequences", sceneName)
		else:
			self.outPath = os.path.join("/raid/compass/backup/output_long/data/simulated", sceneName)
