...
class RenderFolder(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if not self.translation_mode:
            return (indTexList, indImList, weights, depth, diffusion, projectionMatrix, points3D), \
                    (indTexList_2, indImList_2, weights_2, depth_2, diffusion_2, projectionMatrix_2, points3D_2), \
                    scene_idx
        else:
            return (indTexList, indImList, weights, depth, diffusion, projectionMatrix, points3D), \
                    scene_idx, \
